...
public abstract class ARActivity extends /*AppCompat*/Activity implements CameraEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFormat(PixelFormat.TRANSLUCENT);     // 투명도
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);   // 화면 켜짐 지속시간
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE); // 가로 모드 <-> portrait
    ...
    public void cameraPreviewStarted(int width, int height, int rate, int cameraIndex, boolean cameraIsFrontFacing) {
        ...
        String cameraParaPath = "C:\\artoolkit5\\AndroidStudioProjects\\ARSimpleProj\\aRSimple\\src\\main\\assets\\Data\\camera_para.dat";
